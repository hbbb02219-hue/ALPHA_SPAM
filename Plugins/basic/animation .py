...
async def kocok(client: Client, message: Message):
    ...
    await e.edit("ᴀʙᴇ sᴀʟᴇ ᴋʏᴀ ᴅᴇᴋʜ ʀᴀʜᴀ ᴀɪsᴇ ʜɪ ʀɪsʜᴀɴᴛ ʙᴀᴀᴘ ᴛᴇʀɪ ᴍᴀᴀ ᴋᴀ ʙᴜʀ ᴍᴇ ᴋʀᴇɢᴀ")
...
async def hak(client: Client, message: Message):
    ...
    await asyncio.sleep(2)
    await message.edit_text(
        "Targeted Account Hacked...!\n\n ✅ File has been successfully uploaded to my server.\nWhatsApp Database:\n`./DOWNLOADS/msgstore.db.crypt12` 𝐅ᴏʀ 𝐑ᴇᴍᴏᴠᴇ 𝐌ʏ [𝐎ᴡɴᴇʀ Rɪsʜᴀɴᴛ](https://t.me/oye_babyy)"
    )
...
async def awikwok(client: Client, message: Message):
    await edit_or_reply(
        ...
        "▄▀──█▄▄──────█─█▄▄\n"
        "─▄▄▄▀──▀▄───▄▄▄▀──▀▄\n"
        "─▀───────▀▀─▀───────▀▀\n`ɴɪᴋᴀʟ ᴍᴄ😥😥.. ɢᴀᴀʟɪ ɴᴀ ᴅᴇ ᴠᴀʀɴᴀ ʀɪsʜᴀɴᴛ ᴛᴇʀɪ ɢ**ᴅ ᴍᴀᴀʀ ʟᴇɢᴀ.👻`",
    )
